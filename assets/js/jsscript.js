...
//Tombol konfirmasi daftar sidang
$('.sidang').on('click', function (e) {
	e.preventDefault();
	const href = $(this).attr('href');
	Swal.fire({
		title: 'Daftar Sidang Skripsi',
		html: "Apakah anda yakin mendaftarkan Skripsi ini untuk " + '<b>' + 'Sidang Skripsi' + '</b>' + " ?",
		icon: 'warning',
		showCancelButton: true,
		focusConfirm: false,
		confirmButtonColor: '#3085d6',
...
//Tambah Jadwl Sidang
if (flashdata == 'Mendaftarkan Skripsi untuk Sidang berhasil') {
	Swal.fire({
		position: 'center',
		icon: 'success',
		title: flashdata,
