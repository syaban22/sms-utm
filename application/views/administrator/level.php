				...
				<tbody>
					...
					<?php foreach ($level as $l) : ?>
						<tr>
							...
							<td><?= $l['level']; ?></td>
							<td>
								<a href="<?= base_url('administrator/levelAkses/') . $l['id']; ?>" class="btn btn-success btn-sm delete"><i class="fa fa-fw fa-user-check"></i> Akses</a>
	...
	<div class="modal fade" id="ModalHapus<?= $id; ?>" tabindex="-1" role="dialog" aria-labelledby="myModalLabel">
		...
		<div class="modal-dialog" role="document">
			<div class="modal-content">
				...
				<form class="form-horizontal" action="<?= base_url() . 'administrator/delete/' . $id ?>" method="post" enctype="multipart/form-data">
					<div class="modal-body">
